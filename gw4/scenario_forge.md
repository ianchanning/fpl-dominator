...
| Calafiori | DEF | Arsenal | 5.7 | [X]* | [X]* | [X]* | . | . | 60% | PURE PUNT |
| De Cuyper | DEF | Brighton | 4.7 | [X]* | [X]* | . | . | . | 40% | PURE PUNT |
| Hall | DEF | Newcastle | 5.1 | . | . | . | [X]* | . | 20% | FRINGE |
| Mendy | DEF | Hull City | 4.0 | [b] | [b] | [b] | [b] | [X]* | 20% | HORIZON-DEPENDENT |
| Thomas | DEF | Coventry City | 4.0 | [b] | . | [b] | [b] | [b] | 0% | UNSELECTED |
...
| Janelt | MID | Brentford | 5.0 | [X]* | . | [X]* | [X]* | [X]* | 80% | FRINGE |
| Ødegaard | MID | Arsenal | 6.6 | [X]* | . | . | [X]* | . | 40% | PURE PUNT |
| Mbeumo | MID | Man Utd | 7.9 | . | . | . | . | [X]* | 20% | HORIZON-DEPENDENT |
| Stach | MID | Leeds | 6.0 | . | [X]* | . | . | . | 20% | FRINGE |
| Lewis-Potter | MID | Brentford | 5.5 | . | . | [X]* | . | . | 20% | FRINGE |
...
*Diff-First Noise Suppression:* Filtered 1 static bench players (Steele).

## Strategic Asset Classification

- **The Immortals (7 Locks):** Ajayi, B.Fernandes, Gakpo, Haaland, João Pedro, Saka, Tzolakis
- **The Horizon-Dependents (3 Assets):** Mbeumo, Mendy, Tarkowski
- **The Pure Punts (3 Assets):** Calafiori, De Cuyper, Ødegaard
- **The Fringe / Volatile (4 Assets):** Hall, Janelt, Lewis-Potter, Stach
