...
| Surname | Position | Team | Price | EXP:1.00 | EXP:0.50 | EXP:0.00 | Robustness | Classification |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Walle Egeli | FWD | Ipswich Town | 4.5 | [b] | . | . | 0% | UNSELECTED |

*Legend:* `[X]` = Unanimous Starter | `[X]*` = Starting Alteration | `[b]` = Bench | `.` = Unselected

*Diff-First Noise Suppression:* Filtered 2 static bench players (Dovin, Obi).
